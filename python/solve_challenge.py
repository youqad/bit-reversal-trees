...
def main():
    ...
    initial_role = "user" if GENERATOR_MODEL_NAME.startswith(("o1", "o3", "deepseek")) else "system"
    ...
    if (
        GENERATOR_MODEL_NAME.startswith(("o1", "o3", "claude", "anthropic", "deepseek"))
    ):
        # For o1, o3, Claude, and DeepSeek, make separate requests (n>1 is not supported)
